...
<?php if (isset($_GET['lang']) && $_GET['lang']=='eng'){
	echo "d.add(1,0,'<b>Powder Coating</b>','?seccion=pintura-en-polvo-de-aplicacion-electrostatica&lang=eng');
	d.add(2,0,'<b>Pre-treatment and wash system/sandblast</b>','?seccion=sistema-de-pretratamiento-y-lavado-SandBlast&lang=eng');
	d.add(3,0,'<b>Manual application system</b>','?seccion=sistema-de-aplicacion-manual&lang=eng');";
}else{
