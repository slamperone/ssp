...
<div class="clear"></div>
  ...
  <li class="navli"><a href="manufactura.php?seccion=almacen-e-inventarios" class="navlink<?php if($cualEs=='manufactura.php'){echo ' activo';} ?>" >Manufactura</a>
    <div class="subnav" style="display: none;">
      <div class="subnavIn">
        <a href="manufactura.php?seccion=almacen-e-inventarios">
