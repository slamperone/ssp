...
<?php if (isset($_GET['lang']) && $_GET['lang']=='eng'){
echo "d.add(1,0,'<b>Laser Cutter</b>','?seccion=cortadora-laser&lang=eng');
...
d.add(5,0,'<b>Punching</b>','?seccion=troquelado&lang=eng');
d.add(6,0,'<b>Machine Center</b>','?seccion=maquinado&lang=eng');
";
}else{
	echo "d.add(1,0,'<b>Cortadora Laser</b>','?seccion=cortadora-laser');
	;
