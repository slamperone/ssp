...
<table width="147" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="64" valign="top"><div class="script/dtree">
    	<?php
      $productos = array(
        array('CNC Tube Bender  ','La dobladora CNC puede doblar tubos de hasta 2" de diámetro',array('tubeBender700x460.jpg','tubeBender700x4602.jpg','tubeBender700x4603.jpg')),
        ...
        array('Hydraulic Press Brake 8’','Tube / angleCutter',array('AmadaHS700x460.jpg','AmadaHS700x4602.jpg','AmadaHS700x4603.jpg')),
        ...
        array('Manual Cutting','',array('DoringerD700x460.jpg','DoringerD700x4602.jpg')),
        array('3D Scan-to-CAD','centro de maquinado',array('FaroEage700x460.jpg','FaroEage700x4602.jpg')),
        ...
        array('Hydraulic Puncher ','descripcion here',array('italia700x460.jpg','italia700x4602.jpg','italia700x4603.jpg')),
...
<div class="landing-hl herramienta">
        <table width="187" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <p>'.substr($productos[$i][0], 0, 23).'</p></td>
            </tr>
          <tr>
